...
class MessageLoadingPage extends StatelessWidget {
  final TalkToAiLoadingState state;
  final TextEditingController candidateMessage;
  const MessageLoadingPage({
    super.key,
    required this.state,
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => context.read<TalkToAiBloc>().add(
                        SendButtonTappedEvent(message: candidateMessage.text),
                      ),
                    ),
                  ],
                ),
